...
| `component-creator` | Creates UI components from Figma designs with visual verification, Code Connect integration, and component registry management | beta `v0.0.1` |
